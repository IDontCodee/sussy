...
const SWF_CDN = "https://cdn.jsdelivr.net/gh/BinBashBanana/gstore/";
...
(async () => {
    ...
    if(swf) {
        const swfloc = (params.get("cdn") == "true") ? SWF_CDN + swf : swf;
        var data = await fetch(swfloc);
        return loadFile(data.body);
    }
